                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 default-item" style="display: inline-block;">
                            <div class="inner-box">
                                <div class="single-item center">
                                    <figure class="image-box"><img src="{{$product->image}}" alt=""><div class="product-model new">New</div></figure>
                                    <div class="content">
                                        <h3><a href="shop-single.html">{{$product->name}} {{$product->getCategory()->name}}</a></h3>
                ...
                <div class="wrapper">
                    ...
                    <div class="sidebar_categories">
                        ...
                        @foreach($category as $cat)
                            <ul>
                                <li><a href="#" class="tran3s">{{$cat->name}}( {{$cat->products()->count()}} )</a></li>
                            </ul>
                        @endforeach
